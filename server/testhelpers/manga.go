...
// MangaStub is the data necessary to create a manga.
...
// MangaRow represents a row in the manga DB table.
...
// MangaFactory creates a manga row from a MangaStub with defaults and returns it.
